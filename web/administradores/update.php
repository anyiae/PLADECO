                        ...
                        <div class="container">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title"><span class="fa fa-users"></span> Actualización de administrador
                                    </h3>
                                </div> <!-- /.card-body -->
                                <div class="card-body">
                                    <?php
                                    $query2 = $pdo->prepare("SELECT * FROM usuarios WHERE id = '$id_usuario' AND estado ='1'");
                                    $query2->execute();
